...
function SectionThree() {
  ...
  return (
        <div className="div md:px-20   my-10">
           <main  className='md:px-5  rounded-lg py-5 relative bg-indigo-200 '>
            ...
            <div className="top grid md:px-[10rem] px-[15%] py-[3rem] md:grid-cols-2 grid-cols-1 gap-12 ">
                <div className="md:w-[50vh] py-10 bg-white text-left px-5 box-border flex flex-col rounded-md">
