...
function SectionThree() {
  return (
        <div className="div  md:px-[96px]  mt-10 mb-2">
           <main  className='  rounded-lg py-7 pb-[96px] relative bg-indigo-100 '>
            {/* <div className=' absolute h-[100vh] w-[80vh] bg-red-900 ' /> */}
            <h2 className='text-2xl w-[80%] inline-block md:w-[100%] md:text-4xl font-bold my-[50px] mt-[7px] md:my-[90px] text-gray-800'>Benefits of Using Our Cover Letter Builder</h2>
            <div className="top grid md:px-[6rem] px-[7.5%]  lg:grid-cols-2 grid-cols-1 gap-[60px] md:gap-[90px] ">
                <div className=" w-[327] h-[424px] md:w-[65vh] md:h-[320px] py-10 bg-white text-left px-[50px] md:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={circle} className='w-[80px] mb-5 md:mb-3 h-[80px]' alt="" />
                    <p className='font-bold  text-left text-[24px] text-gray-800 '>Make Your Job Search Easy</p>
                ...
                <div className=" w-[327] h-[424px] lg:w-[65vh] md:h-[320px] py-10 bg-white text-left px-[50px] md:px-8 box-border flex flex-col rounded-[8px]">
                    <img src={pen} className='w-[80px] mb-5 md:mb-3 h-[80px]' alt="" />
                    <p className='font-bold  text-left text-[24px] text-gray-800 '>We do the Writing For You</p>
                ...
                <div className=" w-[327] h-[424px] lg:w-[65vh] md:h-[320px] py-10 bg-white text-left px-[50px] md:px-8 box-border flex flex-col rounded-[8px]">
                    ...
                    <p className='font-bold  text-left md:text-[24px] text-gray-800 '>Beautiful and Polished results</p>
                ...
                <div className=" w-[327] h-[424px] lg:w-[65vh] md:h-[320px] py-10 bg-white text-left px-[50px] md:px-8 box-border flex flex-col rounded-[8px]">
                    ...
                    <p className='font-bold  text-left md:text-[24px] text-gray-800 '>Proven Success</p>
