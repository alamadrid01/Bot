  ...
  return (
    <div className='mb-[40px] md:mb-[96px]'>
      ...
      <div className="additional_info_container grid grid-cols-2 gap-[20px] md:grid-cols-4 md:gap-[60px] text-left px-[6.8%]  ">
        ...
        <div className="additional_info px-4 py-3  box-border bg-indigo-100 border-2  border-solid flex flex-col items-center md:w-[272px] md:h-[260px] rounded-lg justify-center">
        ...
        <div className="additional_info px-4 py-3  box-border bg-yellow-100 border-2  border-solid flex flex-col items-center md:w-[272px] md:h-[260px] rounded-lg justify-center">
