  ...
  return (
    <div className='bg-red md:px-[204px] md:py-[120px] font-manrope'>
        <main className=' md:px-[80px] px-[30px] rounded-lg h-sreen pt-12 bg-white ' >
            ...
            <form method="post" action="/generate" encType='multipart/form-data' onSubmit={submit} className="form font-manrope grid w-[100%]  md:grid-cols-2 md:gap-20 gap-12 my-[80px] grid-cols-1 ">
                <div className="left">
                    <div className="a flex font-manrope flex-col text-left mb-[2rem] ">
                        <label className='my-[4px] text-[18px]'>Company's Name</label>
                        <input name='company_name' className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' onChange={companyHandler} autoFocus type="text" value={companyName} id="companyName" />
                        {
                    ...
                    <div className="a flex flex-col text-left mb-[2rem] ">
                        ...
                        <input name='company_address' className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' onChange={companyAddressHandler} type="text" value={companyAddress} id="companyName" />
                        {
                    ...
                    <div className="a grid grid-cols-2 gap-2 mb-[2rem]   ">
                        <div className="b flex flex-col text-left ">
                            ...
                            <input name='city'  className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' onChange={cityHandler} type="text" value={city} id="companyName" />
                            {
                        ...
                        <div className="b  flex flex-col text-left">
                            ...
                            <input name='country' className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' onChange={countryHandler} type="text" value={country} id="companyName" />
                            {
                    ...
                    <div className="a flex flex-col text-left mb-2rem">
                        ...
                        <input name='date' className='px-3 py-[9px]  border-[1.5px] border-gray-300 rounded-md' onChange={dateHandler} type="text" value={date} id="companyName" />
                        {
                ...
                <div className="right mt-[-1rem] md:mt-0 ">
                    <div className="a flex flex-col text-left mb-[2rem] ">
                        ...
                        <input name='role' className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' type="text" onChange={roleHandler} value={role} id="companyName" />
                        {
                    ...
                    <div className="a flex flex-col text-left mb-[2rem] ">
                        ...
                        <input name='years_of_repo' className='px-3 py-[9px] border-[1.5px] border-gray-300 rounded-md' type="text" onChange={yearsHandler} value={years} id="companyName" />
                        {
